...
void UMafiaBaseAssetData::PreSave(FObjectPreSaveContext ObjectSaveContext)
{
...
FSoftObjectPath UMafiaBaseAssetData::GetAssetPathByName(const FName& AssetName)
{
...
const FAssetSet& UMafiaBaseAssetData::GetAssetSetByLabel(const FName& Label)
{
